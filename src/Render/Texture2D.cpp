...
namespace Render
{
	Texture2D::Texture2D(const GLuint width, const GLuint height, const unsigned char* data, const unsigned channels, const GLenum filter, const GLenum wrap_mode) : m_width_(width), m_height_(height)
	{
		switch (channels)
		{
		case 4:
